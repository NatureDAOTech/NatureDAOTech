            ...
            <div className="min-h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8">
                <div className=" pt-4 sm:pt-16">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="max-w-4xl mx-auto text-center">
                            <h2 className="text-3xl font-extrabold text-black sm:text-4xl">
                                Join Nature DAO Team to Collaborate
                            </h2>
                                ...
                                <div className="max-w-4xl mx-auto">
                                    <dl className="rounded-lg bg-white shadow-lg sm:grid sm:grid-cols-3">
                                        <div className="flex flex-col border-b border-gray-100 p-6 text-center sm:border-0 sm:border-r">
                                            ...
                                            <dd className="order-1 text-2xl font-extrabold text-green-600">{parseFloat(stats?.basePrice || "0").toFixed(2)} USDT</dd>
                                        </div>
                                        <div className="flex flex-col border-t border-b border-gray-100 p-6 text-center sm:border-0 sm:border-l sm:border-r">
                                            <dt className="order-2 mt-2 text-lg leading-6 font-medium text-gray-500">Total Supply</dt>
                                            <dd className="order-1 text-2xl font-extrabold text-green-600">{parseFloat(stats?.totalSupplyICO || "0").toFixed(2)}{ }</dd>
                                        </div>
                                        <div className="flex flex-col border-t border-gray-100 p-6 text-center sm:border-0 sm:border-l">
                                            <dt className="order-2 mt-2 text-lg leading-6 font-medium text-gray-500">You Own</dt>
                                            <dd className="order-1 text-2xl font-extrabold text-green-600">{parseFloat(stats?.balanceOf || "0").toFixed(2)}{ }</dd>
                                        </div>
                                    </dl>
                                </div>
                            </div>
                                ...
                                <div className="mt-1">
                                    <input
                                        ...
                                        onChange={(e) => {
                                            ...
                                            setAmount(Math.abs(parseInt(parseFloat(e.target.value) * 100) / 100.0))
                                            // }
                                            // else {
