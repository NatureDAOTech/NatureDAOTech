export default function Privacy() {
    return (       
            <div style={{ backgroundColor: "#E2FACF" }} className="w-full p-8 mt-8 ">
                ...
                This is the Privacy Policy (“Policy”) of NATURE DAO Foundation (together with our affiliates and/or subsidiaries from time to time, including ACCTECHFIN Inc., which shall hereinafter be collectively called “NATURE DAO”). You have been directed to this Policy because we are collecting, using or disclosing your personal data. In this Policy, when we use “we”, “us” or “our”, we refer to the company (within NATURE DAO) which is collecting your personal data, or which is operating the website which you are accessing or using. This Policy applies to all personal data that you may provide to us and the personal data we hold about you. By providing us with your personal data or by accessing, using or viewing our website (including www.naturedao.tech (“website”)), applications, exchanges, wallets, platforms, software, products, services, and the functions or contents therein (including transmitting, caching, or storing of any such personal data) (collectively, “Sites”), you shall be deemed to have agreed to each and all the terms, conditions, and notices in this Policy. If you do not agree, please cease use of the site and do not provide any personal data to us. If you are visiting us from the EU, this Policy complies with the EU General Data Protection Regulation 2016/679 (the “GDPR”). If you are visiting us from United Kingdom, this Policy is subject to the United Kingdom Personal Data Protection Act (No. 26 of 2012) (“PDPA”). This Policy complies with similar personal data protection principles applicable to foreign government agencies.
                </p>
                ...
                4. STORAGE AND RETENTION OF YOUR INFORMATION
                    ...
                    <p className="w-full p-2">
                    4.2 We may store and process all or part of your personal and transactional information, including certain payment information, such as your encrypted bank account and/or routing numbers, in United Kingdom and elsewhere in the world where our facilities or our service providers are located. We protect your personal information by maintaining physical, electronic, and procedural safeguards in compliance with the applicable laws and regulations.
                    </p>
                </p>                
                <p className="w-full p-4">
                5. THIRD-PARTY SITES
