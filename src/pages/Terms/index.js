    ...
    return (       
            <div style={{ backgroundColor: "#E2FACF" }} className="w-full p-8 mt-8 ">
                ...
                <div className="flex mt-8 justify-center">
                    <span className="text-gray-400">Last Updated: Mar 2022</span>
                </div>
                <p className="w-full p-4">
                1. GENERAL
                    <p className="w-full p-2">
                        1.1. This is an agreement (“Agreement”) between you and Nature DAO trading name of ACCTECHFIN CONSULTANCY LTD. (together with our affiliates and/or subsidiaries from time to time, including ACCTECHFIN CONSULTANCY LTD, a company registred at 70 Links Way, Croxley Green, Rickmansworth WD3 3RJ. We provide, amongst other services, decentralised financial (“DeFi”) services and develop applications that connect people to digital assets and DeFi services such as savings and lending.
                    </p>
                    <p className="w-full p-2">
                    ...
                    <p className="w-full p-2">
                    1.5 NATURE DAO shall only operate in jurisdictions where its Digital Currency Services (defined below) are specifically licensed.
                    </p>
                    <p className="w-full p-2">
                    1.6 Even in jurisdictions where NATURE DAO is licensed to provide its Digital Currency Services (defined below), the said services may not necessarily be regulated by the Government and you may therefore not be protected by regulation. You should carefully consider whether trading or holding digital currencies is suitable for you in light of your financial condition. NATURE DAO is not obligated to provide you with legal advice as to whether the said Services are regulated by the government of the jurisdiction that you reside in, and you should seek your own legal advice.
                    </p>
                    <p className="w-full p-2">
                ...
                2. ELIGIBILITY
                    <p className="w-full p-2">
                    2.1 To be eligible to use any of the Digital Currency Services, you must be at least 18 years old and reside in a country in which the said services are accessible. Please note that not all Digital Currency Services are available in every country.
                    </p>
                    <p className="w-full p-2">
                    2.2 By accessing or using the Sites, you represent and warrant that you have not previously been suspended or removed from the Sites. You represent and warrant that you are not: (a) located in, under the control of, or a national or resident of any country to which the United Kingdom has embargoed goods or services. You further represent and warrant that you will not use the Sites if the laws of your country prohibit you from doing so in accordance with these Terms.
                    </p>
                    </p>
                <p className="w-full p-4">
                3. ACCESS TO THE SITES
                    ...
                    <p className="w-full p-2">
                    3.2 In order to access and use certain features on the Sites, you must create an account with us ("NATURE DAO Account"). You agree to: (a) provide accurate, current and complete information when creating or updating a NATURE DAO Account; (b) maintain and promptly update your NATURE DAO Account information; (c) maintain the security and confidentiality of your login credentials and restrict access to your NATURE DAO Account and your computer; (d) promptly notify us if you discover or otherwise suspect any security breaches related to the Sites; and (e) take responsibility for all activities that occur under your NATURE DAO Account and accept all risks of unauthorised access.
                    </p>
                </p>
                <p className="w-full p-4">
                4. DIGITAL CURRENCY SERVICES                    
                    <p className="w-full p-2">
                    4.1 The following services (the “Digital Currency Services”) may be provided to you by NATURE DAO: a. one or more hosted digital currency wallets enabling you to store, track, transfer, and manage balances of certain supported digital currencies including Bitcoin (BTC), Ethereum (ETH), Rio Fuel (RFUEL) and Bitpool Token (BIT) (the “Digital Currency Wallet” and “Digital Currency” respectively); b. one or more hosted digital wallet enabling you to store electronic money issued by NATURE DAO (the "E-Money Wallet" and "E-Money" respectively) (collectively, the “E-Money Services”); c. certain payment services enabling you to send and receive E-Money; and d. a Digital Currency exchange service enabling you to obtain prices for your purchases and sales of Digital Currencies, and (subject to certain restrictions) carry out any such purchases or sales on the Sites.
                    </p>
                    <p className="w-full p-2">
                    4.2 Your Digital Currency Wallet enables you to send Digital Currency to, and request, receive, and store Digital Currency from, third parties by giving instructions through the Sites (each such transaction is a "Digital Currency Transaction"). The Digital Currency Exchange Service enables you to buy Digital Currency using: a. E-Money from / into your E-Money Wallet; and / or b. Central bank issued currency (such as SGD or EUR) supported by NATURE DAO.
                    </p>
                    <p className="w-full p-2">
                    4.3 Conversely, when you sell Digital Currency you may elect to receive: a. E-Money into your E-Money Wallet; and / or b. Central bank issued currency (such as GBP or EUR) supported by NATURE DAO.
                    </p>
                    <p className="w-full p-2">
                    4.4 You may purchase supported Digital Currency by linking a valid payment method to your Digital Currency Wallet. You authorise us to debit funds using your selected payment method(s) to complete your purchase. Although we will attempt to deliver Digital Currency to you as promptly as possible, funds may be debited from your selected payment method before the status of your Digital Currency transaction is shown as complete, and it is delivered to your Digital Currency Wallet. You may sell Digital Currency in exchange for fiat currency (such as SGD or EUR) supported by NATURE DAO. In such circumstances, you authorise us to debit your Digital Currency Wallet and to send instructions to credit your selected payment method(s) in settlement of sell transactions. We will send these instructions as soon as reasonably possible. Any fiat currency should be credited to your selected payment method(s) by the end of the business day after we send such instructions.
                    </p>
                    <p className="w-full p-2">
                    4.5 We will make reasonable efforts to fulfil all purchases of Digital Currency, but in some circumstances, we may be unable to. If this is the case, we will notify you and seek your approval to re-attempt the purchase at the current Exchange Rate (as defined below).
                    </p>
                    <p className="w-full p-2">
                    ...
                    <p className="w-full p-2">
                    4.7 Each purchase or sale of Digital Currency is subject to a fee (a "Conversion Fee"). The applicable Conversion Fee will be displayed to you on the Site prior to each transaction and is stated in each receipt we issue to you. We may adjust our Conversion Fees at any time. We will not process a transaction if the Conversion Fee and any other associated fees would, together, exceed the value of your transaction.    
                    </p>
                    <p className="w-full p-2">
                    4.8 Each purchase or sale of Digital Currency is also subject to the Exchange Rate for the given transaction. The "Exchange Rate" means the price of a given supported Digital Currency in fiat currency as quoted on the Sites. The Exchange Rate is stated either as a "Buy Price" or as a "Sell Price", which is the price at which you may buy or sell Digital Currency, respectively.
                    </p>
                    <p className="w-full p-2">
                    4.9 You acknowledge that the Buy Price Exchange Rate may not be the same as the Sell Price Exchange Rate at any given time, and that we may add a margin or ‘spread’ to the quoted Exchange Rate. You agree to accept the Exchange Rate when you authorise a transaction. We do not guarantee that you will be able to buy and / or sell your Digital Currency on the open market at any particular price or time.    
                    </p>
                    <p className="w-full p-2">
                    4.10 By clicking the Buy or Sell button on the Sites, you are authorising NATURE DAO to initiate the transaction at the quoted Buy Price or Sell Price and agree to any associated Conversion Fees and Exchange Fees. You cannot cancel, reverse, or change any transaction marked as complete or pending. If your payment is not successful or if your payment method has insufficient funds, you authorise us, in our sole discretion, either to cancel the transaction or to debit your other payment methods, including balances on your E-Money Wallet and/or Digital Currency Wallets, in any amount necessary to complete the transaction. You are responsible for maintaining an adequate balance and/or sufficient credit limits in order to avoid overdraft, insufficient funds, or similar fees charged by your payment provider.    
                    </p>
                    <p className="w-full p-2">
                    4.11 We will process Digital Currency Transactions in accordance with the instructions we receive from you. You should verify all transaction information prior to submitting instructions to us. We do not guarantee the identity of any user, receiver, requestee or other third party and we will have no liability or responsibility for ensuring that the information you provide is accurate and complete.    
                    </p>
                    <p className="w-full p-2">
                    4.12 Digital Currency Transactions cannot be reversed once they have been broadcast to the relevant Digital Currency network.    
                    </p>
                    <p className="w-full p-2">
                    4.13 We may charge network fees ("transaction fees") to process a Digital Currency Transaction on your behalf. We will calculate the transaction fees at our discretion, although we will always notify you of the transaction fees at (or before) the time you authorise the Digital Currency Transaction. Transaction fees for each individual transaction will be disclosed to you at the time of purchase on the checkout page. When you or a third party sends Digital Currency to a wallet from an external wallet not hosted by NATURE DAO, the person initiating the transaction is solely responsible for executing the transaction properly, which may include, among other things, payment of transaction fees in order for the transaction to be successful. Non-payment of transaction fees may cause your transaction to remain in a pending state outside of NATURE DAO’s control and we are not responsible for delays or loss incurred as a result of an error in the initiation of the transaction and have no obligation to assist in the remediation of such transactions.    
                    </p>
                    <p className="w-full p-2">
                    4.14 Once submitted to a Digital Currency network, a Digital Currency Transaction will be unconfirmed for a period of time pending sufficient confirmation of the transaction by the Digital Currency network. A Digital Currency Transaction is not complete while it is in a pending state. Digital Currency associated with Digital Currency Transactions that are in a pending state will be designated accordingly and will not be included in your Digital Currency Wallet balance or be available to conduct Digital Currency Transactions until confirmed by the network.
                    </p>
                    <p className="w-full p-2">
                    4.15 Under no circumstances should you attempt to use your Digital Currency Wallet to store, send, request, or receive digital currencies in any form that we do not support (although we will use reasonable efforts to help you move or sell Digital Currency that we no longer support). We assume no responsibility or liability in connection with any attempt to use your Digital Currency Wallet for digital currencies that we do not support. Please contact us if you have any questions about which Digital Currencies we currently support.    
                    </p>
                    <p className="w-full p-2">
                    4.16 If you set up a recurring purchase of Digital Currency (a "Future Transaction"), you authorise us to initiate recurring electronic payments in accordance with your selected Digital Currency Transaction and any corresponding payment accounts, such as direct debits from, or credits to, your linked bank account. Your recurring transactions will occur in identical, periodic instalments, based on your period selection (e.g., daily, weekly, monthly), until either you or NATURE DAO cancels the recurring order. If you select a bank account as your payment method for a recurring transaction, and such transaction falls on a weekend or holiday in the location in which the relevant bank is location, or after the relevant bank’s business hours, the credit or debit will be executed on the next business day, although the Digital Currency fees at the time of the regularly-scheduled transaction will apply. If your bank is unable to process any payment to NATURE DAO, we will notify you of cancellation of the transaction and may avail ourselves of remedies set forth in this Agreement to recover any amount owed to NATURE DAO. This authorisation will remain in full force and effect until you change your recurring transaction settings or until you provide us with written notice. You agree to notify NATURE DAO in writing of any changes in your linked bank account information prior to a recurring transaction.   
                    </p>
                    <p className="w-full p-2">
                    4.17 Unless specifically announced on the Site or via an official public statement of NATURE DAO, we do not support metacoins, coloured coins, side chains, or other derivative, enhanced, or forked protocols, tokens, or coins which supplement or interact with a Digital Currency we support (collectively, "Advanced Protocols"). You should not use your NATURE DAO Account to attempt to receive, request, send, store, or engage in any other type of transaction involving an Advanced Protocol. Our platform is not configured to detect and/or secure Advanced Protocol transactions.     
                    </p>
                    <p className="w-full p-2">
                    4.18 NATURE DAO securely stores Digital Currency private keys, in a combination of online and offline storage, which are the means by which you can securely approve a Digital Currency Transaction. As a result of our security protocols, it may be necessary for us to retrieve private keys or related information from offline storage in order to facilitate a Digital Currency Transaction in accordance with your instructions, and you acknowledge that this may delay the initiation or crediting of such Digital Currency Transaction.
                    </p>
                    <p className="w-full p-2">
                    ...
                    <p className="w-full p-2">
                    4.20 We do not own or control the underlying software protocols which govern the operation of Digital Currencies supported on our platform. Generally, the underlying protocols are ‘open source’ and anyone can use, copy, modify, and distribute them. We assume no responsibility for the operation of the underlying protocols and we are not able to guarantee their functionality, security, or availability. You acknowledge and accept the risk that underlying software protocols relating to any Digital Currency you store in your Digital Currency Wallet may change.
                    </p>
                    <p className="w-full p-2">
                    4.21 In particular, the underlying protocols are likely to be subject to sudden changes in operating rules ("forks"), and such forks may materially affect the value, function, and/or the name of the Digital Currency you store in your Digital Currency Wallet. Where possible, we may provide you with notices or alerts on forks in accordance with this Agreement below and you must read such notices or alerts received from us to consider how to deal with upcoming forks.    
                    </p>
                    <p className="w-full p-2">
                    4.22 However, it is your responsibility to make yourself aware of, and consider how to deal with, upcoming forks. In the event of a fork, there is a risk that we may need to temporarily suspend operations in relation to that fork without providing advance notice to you. We may, in our reasonable discretion, decline to support either or both branches of a fork. You acknowledge the risks presented by forks and you accept that we have no responsibility to assist you to move or sell an unsupported branch of a forked protocol.    
                    </p>
                    <p className="w-full p-2">
                    4.23 All Digital Currencies held in your Digital Currency Wallet are custodial assets held by NATURE DAO for your benefit. Among other things, this means: a. Title to Digital Currency shall at all times remain with you and shall not transfer to any company in NATURE DAO. As the owner of Digital Currency in your Digital Currency Wallet, you shall bear all risk of loss of such Digital Currency. No company within NATURE DAO shall have any liability for fluctuations in the fiat currency value of Digital Currency held in your Digital Currency Wallet. b. You control the Digital Currencies held in your Digital Currency Wallet. At any time, subject to outages, downtime, and other applicable policies, you may withdraw your Digital Currency by sending it to a different blockchain address controlled by you or a third party. c. In order to more securely custody assets, NATURE DAO may use shared blockchain addresses, controlled by a member of NATURE DAO, to hold Digital Currencies held on behalf of customers. Although we maintain separate ledger accounting entries for customer and NATURE DAO Accounts, no member of NATURE DAO shall have any obligation to segregate by blockchain address Digital Currencies owned by you from Digital Currencies owned by other customers or by any member of NATURE DAO.
                    </p>                    
                </p>
                <p className="w-full p-4">
                5. ACCOUNT SETUP
                    <p className="w-full p-2">
                    5.1 To use the Digital Currency Services, you will need to register for a NATURE DAO Account by providing your name, email address and a password and accepting the terms of this Agreement. By using a NATURE DAO Account, you agree and represent that you will use the Digital Currency Services only for yourself, and not on behalf of any third party, unless you have obtained prior approval from NATURE DAO in accordance with this Agreement. You are fully responsible for all activity that occurs under your NATURE DAO Account. We may, in our sole discretion, refuse to open a NATURE DAO Account for you, or limit the number of NATURE DAO Accounts that you may hold or suspend or terminate any NATURE DAO Account or the trading of specific Digital Currency in your account.
                    </p>
                    <p className="w-full p-2">
                    5.2 If, to the extent permitted within this Agreement, or as otherwise permitted by NATURE DAO from time to time, you grant express permission to a third party to access or connect to your NATURE DAO Account(s), either through the third party's product or service or through the Sites, you acknowledge that granting permission to a third party to take specific actions on your behalf does not relieve you of any of your responsibilities under this Agreement. You are fully responsible for all acts or omissions of any third party with access to NATURE DAO Account(s) and any action of such third party shall be considered to be an action authorised by you. Further, you acknowledge and agree that you will not hold NATURE DAO responsible for, and will indemnify NATURE DAO from, any liability arising out of or related to any act or omission of any third party with access to your NATURE DAO Account(s).    
                    </p>
                    <p className="w-full p-2">
                    5.3 You agree to provide us with the information we request for the purposes of identity verification and the detection of money laundering, terrorist financing, fraud, or any other financial crime, and permit us to keep a record of such information. You will need to complete certain verification procedures before you are permitted to start using the Digital Currency Services, including certain transfers of E-Money and Digital Currency, and the limits that apply to your use of the Digital Currency Services may be altered as a result of information collected on an ongoing basis.
                    </p>
                    <p className="w-full p-2">
                ...
                16. CONTACT
                    ...
                    <p className="w-full p-2">
                    16.3 Within 15 business days of our receipt of your complaint the Officer will address all points raised in your complaint by sending you an email in which the Officer will: (i) offer to resolve your complaint in the way your requested; (ii) make a determination rejecting your complaint and set out the reasons for the rejection; or (iii) offer to resolve your complaint with an alternative solution. In exceptional circumstances, if the Officer is unable to respond to your complaint within 15 business days for reasons beyond NATURE DAO’s control, the Officer will send you a holding reply indicating the reasons for a delay in answering your complaint and specifying the deadline by which the Officer will respond to your complaint (which will be no later than 30 business days from our receipt of your complaint).    
                    </p>
                    <p className="w-full p-2">
                    16.4 Any offer of resolution made to you will only become binding on us if accepted by you. An offer of resolution will not constitute any admission by us of any wrongdoing or liability regarding the subject matter of the complaint.    
                    </p>
                </p>
                <p className="w-full p-4">
                17. GOVERNING LAW AND JURISDICTION
                    <p className="w-full p-2">
                    17.1 These Terms are governed by the laws of United Kingdom, and subject to the non-exclusive jurisdiction of the courts of the Republic of United Kingdom for any suit, action or proceeding arising out of these Terms.    
                    </p>
                    <p className="w-full p-2">
                    17.2 If it has not been possible to resolve a dispute through the dispute process set out above, any dispute arising out of or in connection with this Agreement, including any question regarding the existence, validity or termination of this Agreement, shall be referred to and finally resolved by arbitration under the Arbitration Rules of the United Kingdom International Arbitration Centre, which are deemed to be incorporated by reference into this Section.    
                    </p>
                    <p className="w-full p-2">
                    17.3 The tribunal shall consist of three arbitrators. The place and seat of the arbitration shall be United Kingdom. The language to be used in the arbitration proceedings will be English. The decision of the arbitrators will be final, binding and enforceable against you and us, and a judgment upon any award rendered by the arbitrators may be entered in any court having jurisdiction. In no event will the arbitrators have the authority to make any award that provides for punitive or exemplary damages.
                    </p>
                </p>
                <p className="w-full p-4">
                18. DATA PROTECTION
                ...
                19. MISCELLANEOUS
                    <p className="w-full p-2">
                    19.1 This Agreement (including documents incorporated by reference herein) comprise the entire understanding and agreement between you and NATURE DAO as to the subject matter hereof, and it supersedes any and all prior discussions, agreements and understandings of any kind (including without limitation any prior versions of this Agreement), and every nature between and among you and NATURE DAO.    
                    </p>
                    <p className="w-full p-2">
                    19.2 This Agreement is personal to you and you cannot transfer or assign your rights, licenses, interests and/or obligations to anyone else. We may transfer or assign our rights licenses, interests and / or our obligations at any time, including as part of a merger, acquisition or other corporate reorganisation involving NATURE DAO, provided that this transfer or assignment does not materially impact the quality of the services you receive. Subject to the foregoing, this Agreement will bind and inure to the benefit of the parties, their successors and permitted assigns.    
                    </p>
                    <p className="w-full p-2">
                    19.3 If any provision of this Agreement is determined to be invalid or unenforceable under any applicable law, this will not affect the validity of any other provision. If any provision is found unenforceable, the unenforceable provision will be severed, and the remaining provisions will be enforced.    
                    </p>
                    <p className="w-full p-2">
                    19.4 We may not always strictly enforce our rights under this Agreement. If we do choose not to enforce our rights at any time, this is a temporary measure and we may enforce our rights strictly again at any time.    
                    </p>
                    <p className="w-full p-2">
                    19.5 This Agreement and any information or notifications that you or we are to provide should be in English. Any translation of this Agreement or other documents is provided for your convenience only and may not accurately represent the information in the original English. In the event of any inconsistency, the English language version of this Agreement or other documents shall prevail.    
                    </p>
                    <p className="w-full p-2">
                    19.6 In the event that NATURE DAO is acquired by or merged with a third party entity, we reserve the right, in any of these circumstances, to transfer or assign the information we have collected from you and our relationship with you (including this Agreement) as part of such merger, acquisition, sale, or other change of control.    
                    </p>
                    <p className="w-full p-2">
                    19.7 All provisions of this Agreement which by their nature extend beyond the expiration or termination of this Agreement, including, without limitation, the Sections relating to suspension or termination, NATURE DAO Account cancellation, debts owed to NATURE DAO, general use of the Sites, disputes with NATURE DAO, and general provisions will continue to be binding and operate after the termination or expiration of this Agreement.    
                    </p>
                </p>
            </div>
        )
